...
void loop() {
  ...
  */
  ...
  long int therm_res_1 = (biasResistance) / (((4096 -1)/volt1) - 1);
  long int therm_res_2 = (biasResistance) / (((4096 -1)/volt2) - 1);
  long int therm_res_3 = (biasResistance) / (((4096 -1)/volt3) - 1); /* maybe use 4096 instead of 1024 for this? should this be the gain (5v) */
